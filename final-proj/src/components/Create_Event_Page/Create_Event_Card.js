...
class CreateEventCard extends Component {
  ...
  createEvent = (e) => {
      e.preventDefault()
      const start = Date.parse(`${this.startDayRef.current.value} ${this.startMonthRef.current.value} ${this.startYearRef.current.value}`)  // needs time
      const end = Date.parse(`${this.endDayRef.current.value} ${this.endMonthRef.current.value} ${this.endYearRef.current.value}`) // needs time
      ...
      axios.post(url, eventAttributes)
        .then((result) => {
          ...
          <Form>
            <Form.Row>
              <Form.Group as={Col}> 
                ...
                <Form.Control ref={this.nameRef} size="lg" type="text" placeholder="Enter event name" />
              </Form.Group>
            </Form.Row>
            ...
            <Form.Row>
              <Form.Group as={Col}>
                ...
                <Form.Control ref={this.descriptionRef} type="text" placeholder="Enter event description" />
              </Form.Group>
              <Form.Group>
                <Form.Label>Organization</Form.Label>
                <Form.Control ref={this.organizationRef} type="text" placeholder="Enter the name of your organization" />
              </Form.Group>
              <Form.Group as={Col}>
            ...
            <Form.Row>
              <Form.Group as={Col}>
                ...
                <TimePicker ref={this.startTimeRef} onClick={this.handleTimeChangeStart} value={this.state.startTime} start="00:00" end="23:45" step={15} />
              </Form.Group>
              <Form.Group as={Col}>
                <Form.Label>End Time:</Form.Label>
                <TimePicker ref={this.endTimeRef} onClick={this.handleTimeChangeEnd} value={this.state.endTime} start="00:00" end="23:45" step={15} />
              </Form.Group>
            </Form.Row>
            ...
            <Form.Row>
              <Form.Group as={Col}>
                ...
                <Form.Control ref={this.startDayRef} type="text" placeholder="1-31"/>
              </Form.Group>
              <Form.Group as={Col}>
              ...
              <Form.Group as={Col}>
                <Form.Label>Day</Form.Label>
                <Form.Control ref={this.endDayRef} type="text" placeholder="1-31"/>
              </Form.Group>
              <Form.Group as={Col}>
                <Form.Label>Month</Form.Label>
            ...
            <Form.Row>
              ...
              <Form.Group as={Col} controlId="formGridWebsite">
                ...
                <Form.Control ref={this.websiteRef} type="text" placeholder="Enter event website" />
              </Form.Group>

              <Form.Group as={Col} controlId="formGridImage">
                <Form.Label>Image</Form.Label>
                <Form.Control ref={this.imageRef} type="text" placeholder="Enter the link to the image" />
              </Form.Group>
            </Form.Row>
            ...
            <Form.Group controlId="formGridAddress1">
              ...
              <Form.Control ref={this.addressOneRef} placeholder="1234 Main St" />
            </Form.Group>

            <Form.Group controlId="formGridAddress2">
              <Form.Label>Address 2</Form.Label>
              <Form.Control ref={this.addressTwoRef} placeholder="Apartment, studio, or floor" />
            </Form.Group>
            ...
            <Button variant="primary" type="submit" onClick={(e) => this.createEvent(e)}>
              Submit
            </Button>
          </Form>
        </div>
