                ...
                <div className = 'eventpage-content'>
                    <div className = 'name-signup'>
                        ...
                        <div className = 'signup'>
                            ...
                            <p className = 'detail-title-text' style = {{marginLeft: "20px", marginTop: "20px"}}>SIGN UP</p>
                        ...
                        <div className = 'description-wrapper'>
                            <div className = 'detail-content'>
                                <div className = "description-wrapper-sub">
                                    <p className = 'detail-title-text' style = {{marginLeft: "20px", marginTop: "20px"}}>DESCRIPTION</p>
